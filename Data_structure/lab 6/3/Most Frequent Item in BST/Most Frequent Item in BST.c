...
while(counter2 < elements_number + 1) {
            ...
            if (node2 != NULL){
                    if(counter2 == in_left * 2 ){
                        ...
                        if(node4->left != NULL){
                                ...
                                arr[counter_test] = node4->left->data;
                        ...
                        if(node4->right != NULL){
                                //printf("data number %d is = %d \n",counter2 ,node4->right->data);
                                 arr[counter_test] = node4->right->data;
    ...
    int i;
    //sort array ;
    for(i=0; i<counter_test ; i++){
            for (j=i;j<counter_test;j++){
                if(arr[j]< arr[i]){
                    int temp = arr[i];
                    arr[i] = arr[j];
                    arr[j] = temp;
